...
import CreateModal from "../Products/Partials/CreateModal";
import DeleteModal from "../Products/Partials/DeleteModal";
import EditModal from "../Products/Partials/EditModal";
import RestoreModal from "../Products/Partials/RestoreModal";
import config from "../Products/table-config";

const ProductsTable = ({ category, productsResource, categories }) => {
    const {
        data: products,
        meta,
        queries,
    ...
    const reload = useCallback(
        debounce((query) => {
            ...
            router.post(route("category.show", category.slug), pickBy(query), {
                preserveState: true,
                preserveScroll: true,
            });
        }, 300),
