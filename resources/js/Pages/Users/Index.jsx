...
const Index = ({ departments, roles, ...props }) => {
    const { data: users, meta, queries, attributes } = props.users;
    ...
    const reload = useCallback(
        debounce((query) => {
            ...
            router.get(route("user.index"), pickBy(query), {
                preserveState: true,
                preserveScroll: true,
            });
        }, 300),
...
Index.layout = (page) => <DashboardLayout children={page} title="Users" />;
