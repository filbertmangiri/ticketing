...
const Index = ({ technicians, ...props }) => {
    const { data: tasks, meta, queries, attributes } = props.tasks;
    ...
    const reload = useCallback(
        debounce((query) => {
            ...
            router.get(route("task.index"), pickBy(query), {
                preserveState: true,
                preserveScroll: true,
            });
        }, 300),
...
Index.layout = (page) => <DashboardLayout children={page} title="Tasks" />;
