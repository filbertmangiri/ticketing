...
const RestoreModal = ({ isOpen, close, subDepartment, restoreHandler }) => {
    return (
        <Modal
            title={`Restore sub-department - <b>${subDepartment.name}</b>`}
            isOpen={isOpen}
            close={close}
        >
            <Modal.Body className="flex flex-col gap-y-3">
                Are you sure to restore this sub-department?
            </Modal.Body>
